...
- **FR-027**: Undocumented env vars: AUTH_TYPE, CALENDARTOOL, CONTACTSTOOL, EUNOMIA_POLICY_FILE, EUNOMIA_TYPE, FILESTOOL, NEXTCLOUD_PASSWORD, NEXTCLOUD_SSL_VERIFY, NEXTCLOUD_USERNAME, OTEL_EXPORTER_OTLP_ENDPOINT
- **FR-028**: 3 Python env vars not in .env.example: NEXTCLOUD_PASSWORD, NEXTCLOUD_SSL_VERIFY, NEXTCLOUD_USERNAME
