[ ![Logo](https://docs.nextcloud.com/server/14/developer_manual/_static/logo-white.png) ](https://docs.nextcloud.com/server/14/developer_manual/index.html)
  ...
  * [](https://docs.nextcloud.com/server/14/developer_manual/commun/index.html)
...
[Nextcloud 14 Developer Manual](https://docs.nextcloud.com/server/14/developer_manual/index.html)
  ...
  * [ Edit on GitHub](https://github.com/nextcloud/documentation/edit/stable14/developer_manual/commun/index.rst)


* * *
# Help and communication[¶](https://docs.nextcloud.com/server/14/developer_manual/commun/index.html#help-and-communication "Permalink to this headline")
## Forums[¶](https://docs.nextcloud.com/server/14/developer_manual/commun/index.html#forums "Permalink to this headline")
Communicate via our [forums](https://help.nextcloud.com).
## IRC channels[¶](https://docs.nextcloud.com/server/14/developer_manual/commun/index.html#irc-channels "Permalink to this headline")
Chat with us on [IRC](http://www.irchelp.org/). All channels are on **irc.freenode.net** :
  * Setup: **#nextcloud**
...
## Maintainers[¶](https://docs.nextcloud.com/server/14/developer_manual/commun/index.html#maintainers "Permalink to this headline")
  * [Contact](https://nextcloud.com/contact/) a maintainer of a certain app or division


[Next ](https://docs.nextcloud.com/server/14/developer_manual/api.html "API Documentation") [](https://docs.nextcloud.com/server/14/developer_manual/bugtracker/triaging.html "Nextcloud bug triaging")
* * *
