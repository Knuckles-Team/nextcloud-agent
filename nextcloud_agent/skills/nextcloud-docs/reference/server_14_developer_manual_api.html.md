[ ![Logo](https://docs.nextcloud.com/server/14/developer_manual/_static/logo-white.png) ](https://docs.nextcloud.com/server/14/developer_manual/index.html)
  ...
  * [](https://docs.nextcloud.com/server/14/developer_manual/api.html)
    * [](https://docs.nextcloud.com/server/14/developer_manual/api.html#php-public-api)
      * [/OCP namespace](https://docs.nextcloud.com/server/14/developer_manual/api/OCP/index.html)
    * [](https://docs.nextcloud.com/server/14/developer_manual/api.html#php-class-reference)
      * [/ namespace](https://docs.nextcloud.com/server/14/developer_manual/api/index.html)
      * [/OC namespace](https://docs.nextcloud.com/server/14/developer_manual/api/OC/index.html)
...
[Nextcloud 14 Developer Manual](https://docs.nextcloud.com/server/14/developer_manual/index.html)
  ...
  * API Documentation
  * [ Edit on GitHub](https://github.com/nextcloud/documentation/edit/stable14/developer_manual/api.rst)


* * *
# API Documentation[¶](https://docs.nextcloud.com/server/14/developer_manual/api.html#api-documentation "Permalink to this headline")
## PHP public API[¶](https://docs.nextcloud.com/server/14/developer_manual/api.html#php-public-api "Permalink to this headline")
  * [/OCP namespace](https://docs.nextcloud.com/server/14/developer_manual/api/OCP/index.html)


## PHP class reference[¶](https://docs.nextcloud.com/server/14/developer_manual/api.html#php-class-reference "Permalink to this headline")
Please note that only APIs in OCP namespace are considered to be public. The following documentation is just for reference:
  * [/ namespace](https://docs.nextcloud.com/server/14/developer_manual/api/index.html)
  * [/OC namespace](https://docs.nextcloud.com/server/14/developer_manual/api/OC/index.html)


[Next ](https://docs.nextcloud.com/server/14/developer_manual/api/OCP/index.html "OCP") [](https://docs.nextcloud.com/server/14/developer_manual/commun/index.html "Help and communication")
* * *
