[ ![Logo](https://docs.nextcloud.com/server/14/developer_manual/_static/logo-white.png) ](https://docs.nextcloud.com/server/14/developer_manual/index.html)
  ...
  * [](https://docs.nextcloud.com/server/14/developer_manual/app/startapp.html)
    * [Enable the app](https://docs.nextcloud.com/server/14/developer_manual/app/startapp.html#enable-the-app)
    * [App architecture](https://docs.nextcloud.com/server/14/developer_manual/app/startapp.html#app-architecture)
...
[Nextcloud 14 Developer Manual](https://docs.nextcloud.com/server/14/developer_manual/index.html)
  ...
  * [App development](https://docs.nextcloud.com/server/14/developer_manual/app/index.html) »
  * Create an app
  * [ Edit on GitHub](https://github.com/nextcloud/documentation/edit/stable14/developer_manual/app/startapp.rst)


* * *
# Create an app[¶](https://docs.nextcloud.com/server/14/developer_manual/app/startapp.html#create-an-app "Permalink to this headline")
After [you’ve set up the development environment](https://docs.nextcloud.com/server/14/developer_manual/general/devenv.html) change into the Nextcloud apps directory:
```
cd /var/www/nextcloud/apps

```

Then create a skeleton app in the [app store](https://apps.nextcloud.com/developer/apps/generate). This doesn’t publish anything on the appstore yet, it just gives you a download.
## Enable the app[¶](https://docs.nextcloud.com/server/14/developer_manual/app/startapp.html#enable-the-app "Permalink to this headline")
The app can now be enabled on the Nextcloud apps page.
## App architecture[¶](https://docs.nextcloud.com/server/14/developer_manual/app/startapp.html#app-architecture "Permalink to this headline")
...
[Next ](https://docs.nextcloud.com/server/14/developer_manual/app/init.html "Navigation and pre-app configuration") [](https://docs.nextcloud.com/server/14/developer_manual/app/tutorial.html "Tutorial")
* * *
